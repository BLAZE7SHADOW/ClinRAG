...
- [ ] **Fri (combined Thu+Fri)** — Embeddings + vector store baseline (Cohere v4 via Bedrock, FAISS) [x], hybrid retrieval (BM25 + reciprocal rank fusion with dense) [x] — both done, see Notes.md Day 3/4. Still open: wire in a simple LLM call for generation. Plan slipped a day; Sat/Sun shift back accordingly.
