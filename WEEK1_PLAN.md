...
- [ ] **Thu** — Embeddings + vector store baseline: pick embedding model, get naive top-k dense retrieval working.
- [ ] **Fri** — Hybrid retrieval: BM25 + reciprocal rank fusion with dense, wire in a simple LLM call for generation.
